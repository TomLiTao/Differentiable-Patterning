...
data = load_textures(["dotted/dotted_0109.jpg","honeycombed/honeycombed_0059.jpg","veined/veined_0095.jpg"],downsample=2,crop_square=True,crop_factor=2)
t=64
iters=2000
...
opt = NCA_Trainer(nca,
				  ...
				  model_filename="emoji_texture_nca_test_17",
