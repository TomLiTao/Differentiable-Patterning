...
data = load_textures(["dotted/dotted_0109.jpg","honeycombed/honeycombed_0059.jpg","honeycombed/honeycombed_0059.jpg"],downsample=4,crop_square=True)
t=64
iters=1000
...
opt = NCA_Trainer(nca,
				  ...
				  model_filename="emoji_texture_nca_test_11",
