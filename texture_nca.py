...
data = load_textures(["banded/banded_0109.jpg","dotted/dotted_0109.jpg","dotted/dotted_0109.jpg"],downsample=2,crop_square=True,crop_factor=1.5)
...
opt = NCA_Trainer(nca,
				  data,
				  model_filename="texture_gated_nca_test_7",
