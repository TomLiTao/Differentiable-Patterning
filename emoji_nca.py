...
if data_index == 0:
    data = load_emoji_sequence(["crab.png","microbe.png","alien_monster.png"],downsample=1)
    data_filename = "cr_mi_al"
if data_index == 1:
    data = load_emoji_sequence(["microbe.png","avocado_1f951.png","alien_monster.png"],downsample=1)
    data_filename = "mi_av_al"
if data_index == 2:
    data = load_emoji_sequence(["avocado_1f951.png","mushroom_1f344.png","lizard_1f98e.png"],downsample=1)
    data_filename = "av_mu_li"
if data_index == 3:
    data = load_emoji_sequence(["mushroom_1f344.png","alien_monster.png","rooster_1f413.png"],downsample=1)
    data_filename = "mu_al_ro"
if data_index == 4:
    data = load_emoji_sequence(["alien_monster.png","mushroom_1f344.png","alien_monster.png"],downsample=1)
    data_filename = "al_mu_al"
if data_index == 5:
    data = load_emoji_sequence(["butterfly.png","eye.png","lizard_1f98e.png"],downsample=1)
    data_filename = "bu_ey_li"
if data_index == 6:
    data = load_emoji_sequence(["rooster_1f413.png","butterfly.png","eye.png"],downsample=1)
    data_filename = "ro_bu_ey"
if data_index == 7:
    data = load_emoji_sequence(["lizard_1f98e.png","microbe.png","anatomical_heart.png"],downsample=1)
